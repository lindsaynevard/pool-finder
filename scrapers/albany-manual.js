...
// Schedule updated June 2026 from PDF at albanyaquaticcenter.com/pool-schedule
// Indoor: Mon/Wed have the same pattern; Tue/Thu have the same pattern
// Tot Swim = ages 4 and under with adult (indoor only, lanes 1-3, shared with water walk)
// Family/Rec Swim = all ages (indoor lanes 1-3 and/or 4-6; outdoor rec/diving lanes)
const WEEKLY = {
  monday: [
    ...
    { start: '1:00 PM', end: '3:00 PM', type: 'rec',    pool: 'albany-outdoor', notes: null },
    { start: '4:45 PM', end: '8:00 PM', type: 'lap',    pool: 'albany-outdoor', notes: null },
  ...
  tuesday: [
    ...
    { start: '6:00 AM', end: '8:00 AM', type: 'lap',    pool: 'albany-outdoor', notes: null },
    { start: '8:00 AM', end: '3:00 PM', type: 'lap',    pool: 'albany-outdoor', notes: null },
    { start: '1:00 PM', end: '3:00 PM', type: 'rec',    pool: 'albany-indoor',  notes: null },
    { start: '1:00 PM', end: '3:00 PM', type: 'rec',    pool: 'albany-outdoor', notes: null },
    { start: '4:45 PM', end: '8:00 PM', type: 'lap',    pool: 'albany-outdoor', notes: null },
    { start: '6:30 PM', end: '8:00 PM', type: 'lap',    pool: 'albany-indoor',  notes: null },
  ...
  friday: [
    ...
    { start: '8:00 AM', end: '12:30 PM', type: 'lap',   pool: 'albany-outdoor', notes: null },
  ...
  saturday: [
    { start: '7:00 AM', end: '11:00 AM', type: 'lap',   pool: 'albany-outdoor', notes: null },
    ...
    { start: '11:00 AM', end: '1:00 PM', type: 'lap',   pool: 'albany-outdoor', notes: null },
    { start: '1:00 PM', end: '4:00 PM', type: 'rec',    pool: 'albany-indoor',  notes: null },
    { start: '1:30 PM', end: '4:00 PM', type: 'rec',    pool: 'albany-outdoor', notes: null },
    { start: '1:00 PM', end: '4:00 PM', type: 'lap',    pool: 'albany-outdoor', notes: null },
  ],
  sunday: [
    { start: '8:00 AM', end: '11:55 AM', type: 'tot',   pool: 'albany-indoor',  notes: null },
    { start: '8:00 AM', end: '1:00 PM', type: 'lap',    pool: 'albany-outdoor', notes: null },
