export const POOLS = [
  ...
  },
  {
    ...
    city: 'Berkeley',
    description: 'Outdoor 50-meter pool on the UC Berkeley campus (Spieker Aquatics Complex). Open to the public for lap swim.',
    swimTypes: ['lap'],
  ...
  },
  {
    ...
    name: 'King Pool',
    city: 'Berkeley',
    description: 'Outdoor city pool in South Berkeley. Seasonal lap and family swim, with a zero-depth entry area for kids.',
    swimTypes: ['lap', 'family'],
  ...
  },
  {
    ...
    city: 'Richmond',
    description: 'Outdoor seasonal pool in Richmond. Lap and family swim, open summers only.',
    swimTypes: ['lap', 'family'],
  ...
  },
  {
    ...
    city: 'Piedmont',
    description: 'Outdoor pool complex with a 12-lane competition pool and a separate activity pool. Lap, open, and family swim sessions.',
    swimTypes: ['lap', 'family'],
